<?php include "conn.php"; 
    ...
    `estabelecimento` WHERE id_estabelecimento=:pid');
    $nome->bindValue(':pid',$id);
    $nome->execute();
    $rownome=$nome->fetch();
    if($rownome['eh_funcionario']==1){
        session_destroy();
        header('location:login.php');
    }
?>
...
<body class="Forms">
    <div class="container-fluid header">
        <div class="row">
            ...
            <div class="col-md-1 col-sm-12 my-sm-4 ps-0 mb-4 text-sm-start text-center">
                <a class="nav-link" href="./homeEstab.php">Home</a>
            </div>
            <div class="col-md-1 col-sm-12 my-sm-4 ps-0 mb-4 text-sm-start text-center">
                <a class="nav-link" href="./homeEstab.php">Vagas</a>
            </div>
            <div class="col-md-1 col-sm-12 my-sm-4 ps-0 mb-4 text-sm-start text-center">
                <a class="nav-link" href="./homeEstab.php">Perfil</a>
            </div>
            <div class="col-md-1 col-sm-12 my-3">
            </div>
        </div>
    ...
    <div class="container-fluid degrade topo">
        ...
        <div class="col-md-10 col-sm-12 my-3 ps-sm-5 ps-0 titulo">
            <?php 
            echo "<h5> Bem vindo(a) ".$rownome['nm_estabelecimento']."</h5>"; ?>
            <?php 
            if(isset($_GET['aviso'])){
                echo "Deseja realmente sair?
                <a class='log-link' href='homeEstab.php?logout'>Sim <a class='log-link' href='home.php'> Não</a></a>";
            }
    ...
    <footer class="container-fluid footer">
        <div class="row">
            ...
            <div class="col-sm-1">
                <a class="nav-link" href='homeEstab.php?aviso'>Sair</a>
            </div>
