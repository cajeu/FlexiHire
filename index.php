    ...
    <div class="container-fluid degrade">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12 my-sm-4 text-sm-start text-center py-sm-0 py-3">
                <a href="./cadastroFunc.php" class="btn btn-primary border-0">Cadastro de <br/>Funcionário</a>
            </div>
            <div class="col-md-3 col-sm-12 my-sm-4 mb-4 text-sm-start text-center py-sm-0 py-3">
                <a href="./cadastroEstab.php" class="btn btn-primary border-0">Cadastro de <br/>Estabelecimento</a>
            </div>
        </div>
    </div>
